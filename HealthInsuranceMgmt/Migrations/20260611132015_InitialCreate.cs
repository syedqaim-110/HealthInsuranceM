        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Policies_CompanyDetails_CompanyDetailId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmpRegisterId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PolicyId = table.Column<int>(type: "int", nullable: false),
                    AssignedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExpiryDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ClaimAmountCredited = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ClaimSettledDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PoliciesOnEmployees", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PoliciesOnEmployees_AspNetUsers_EmpRegisterId",
                        column: x => x.EmpRegisterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PolicyRequestDetails_AspNetUsers_EmpRegisterId",
                        column: x => x.EmpRegisterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PolicyRequestDetailId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PolicyApprovalDetails_AspNetUsers_ApprovedById",
                        column: x => x.ApprovedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PolicyApprovalDetails_PolicyRequestDetails_PolicyRequestDetailId",
                        column: x => x.PolicyRequestDetailId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Policies_CompanyDetailId",
                table: "Policies",
                column: "CompanyDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_PoliciesOnEmployees_EmpRegisterId",
                table: "PoliciesOnEmployees",
                column: "EmpRegisterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PolicyApprovalDetails_ApprovedById",
                table: "PolicyApprovalDetails",
                column: "ApprovedById");

            migrationBuilder.CreateIndex(
                name: "IX_PolicyApprovalDetails_PolicyRequestDetailId",
                table: "PolicyApprovalDetails",
                column: "PolicyRequestDetailId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PolicyRequestDetails_EmpRegisterId",
